...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "5040167527:AAFUJuncv4BKGJa29JEmdAFb68POrDm8UUY")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "AviT98_bot") # Bot username without @.
